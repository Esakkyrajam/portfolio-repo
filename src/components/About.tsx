...
const About = () => {
  ...
  useEffect(() => {
    ...
    const skills = ['Java', 'MERN Stack', 'Spring Boot', 'React', 'Full-Stack Developer'];
    ...
    const type = () => {
      ...
      if (isDeleting) {
        typewriterEl.textContent = currentSkill.substring(0, currentCharIndex - 1);
        currentCharIndex--;
          ...
          <div className="fade-left">
            <div className="sticky top-32">
              ...
              <p className="text-lg mb-6 text-foreground/80">
                ...
                I create scalable, efficient, and user-friendly applications.
              </p>
              
              <p className="text-lg mb-6 text-foreground/80">
                I'm currently specializing as a <span ref={typewriterRef} className="font-medium text-primary"></span><span className="font-medium text-primary border-r-2 border-primary animate-blink">&nbsp;</span>
              </p>
              
              <div className="flex space-x-4 mb-8">
                <a href="https://github.com/esakky" target="_blank" rel="noopener noreferrer" className="social-icon">
                  <Github className="h-5 w-5" />
                </a>
                <a href="https://linkedin.com/in/esakky" target="_blank" rel="noopener noreferrer" className="social-icon">
                  <Linkedin className="h-5 w-5" />
                </a>
              </div>
              
              <a href="#projects" className="inline-flex items-center text-primary font-medium hover:underline" onClick={(e) => {
                e.preventDefault();
